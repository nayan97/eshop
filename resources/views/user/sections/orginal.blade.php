<div class="container">
    ...
    <div class="tab tab-nav-boxed tab-nav-outline appear-animate fadeIn appear-animation-visible"
        ...
        <ul class="nav nav-tabs justify-content-center" role="tablist">
            ...
            <li class="nav-item mr-0 mb-2">
                <a class="nav-link br-sm font-size-md ls-normal active" href="#tab1-4">Featured</a>
            </li>
        </ul>
    </div>
    <!-- End of Tab -->
    <div class="tab-content product-wrapper appear-animate fadeIn appear-animation-visible"
        ...
        <!-- End of Tab Pane -->
        <div class="tab-pane pt-4 active in" id="tab1-4">
            <div class="row cols-xl-5 cols-md-4 cols-sm-3 cols-2">
                <div class="product-wrap">
                    <div class="product text-center">
                        <figure class="product-media">
        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-sm-8">
                <div class="swiper-container swiper-theme swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events"
                    ...
                    <div class="swiper-wrapper " id="swiper-wrapper-b34b8e89ede7dd9d" aria-live="polite"
                        style="transform: translate3d(0px, 0px, 0px);">
                        <div class="swiper-slide product-col swiper-slide-active" role="group"
                            aria-label="1 / 4" style="width: 216.25px; margin-right: 20px;">
                        ...
                        <div class="swiper-slide product-col swiper-slide-next" role="group" aria-label="2 / 4"
                            style="width: 216.25px; margin-right: 20px;">
                            <div class="product-wrap product text-center">
                                <figure class="product-media">
                                    <a href="#">
                        ...
                        <div class="swiper-slide product-col" role="group" aria-label="3 / 4"
                            style="width: 216.25px; margin-right: 20px;">
                            <div class="product-wrap product text-center">
                                <figure class="product-media">
                                    <a href="#">
                        ...
                        <div class="swiper-slide product-col" role="group" aria-label="4 / 4"
                            style="width: 216.25px; margin-right: 20px;">
                            <div class="product-wrap product text-center">
                                <figure class="product-media">
                                    <a href="#">
        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-sm-8">
                <div class="swiper-container swiper-theme swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events"
                    ...
                    <div class="swiper-wrapper " id="swiper-wrapper-0e9d610c5c7126867" aria-live="polite"
                        style="transform: translate3d(0px, 0px, 0px);">
                        <div class="swiper-slide product-col swiper-slide-active" role="group"
                            aria-label="1 / 4" style="width: 216.25px; margin-right: 20px;">
                            <div class="product-wrap product text-center">
        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-sm-8">
                <div class="swiper-container swiper-theme swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events"
                    ...
                    <div class="swiper-wrapper " id="swiper-wrapper-ba7a5b1cd51713e4" aria-live="polite"
                        style="transform: translate3d(0px, 0px, 0px);">
                        <div class="swiper-slide product-col swiper-slide-active" role="group"
                            aria-label="1 / 4" style="width: 216.25px; margin-right: 20px;">
                            <div class="product-wrap product text-center">
    ...
    <div class="swiper-container swiper-theme brands-wrapper mb-9 appear-animate swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events"
        data-swiper-options="{
                    'spaceBetween': 0,
                    'slidesPerView': 2,
                    'breakpoints': {
        ...
        <div class="swiper-wrapper " id="swiper-wrapper-715210e10e78b0607a" aria-live="polite"
            style="transform: translate3d(0px, 0px, 0px);">
            <div class="swiper-slide brand-col swiper-slide-active" role="group" aria-label="1 / 6"
                style="width: 206.667px;">
            ...
            <div class="swiper-slide brand-col swiper-slide-next" role="group" aria-label="2 / 6"
                style="width: 206.667px;">
                <figure class="brand-wrapper">
            ...
            <div class="swiper-slide brand-col" role="group" aria-label="3 / 6" style="width: 206.667px;">
                <figure class="brand-wrapper">
            ...
            <div class="swiper-slide brand-col" role="group" aria-label="4 / 6" style="width: 206.667px;">
                <figure class="brand-wrapper">
            ...
            <div class="swiper-slide brand-col" role="group" aria-label="5 / 6" style="width: 206.667px;">
                <figure class="brand-wrapper">
            ...
            <div class="swiper-slide brand-col" role="group" aria-label="6 / 6" style="width: 206.667px;">
                <figure class="brand-wrapper">
    ...
    <div class="post-wrapper appear-animate mb-4">
        ...
        <div class="swiper">
            <div class="swiper-container swiper-theme swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events"
                ...
                <div class="swiper-wrapper " id="swiper-wrapper-eb4311104547fd824" aria-live="polite"
                    style="transform: translate3d(0px, 0px, 0px);">
                    <div class="swiper-slide post text-center overlay-zoom swiper-slide-active" role="group"
                        aria-label="1 / 4" style="width: 295px; margin-right: 20px;">
                    ...
                    <div class="swiper-slide post text-center overlay-zoom swiper-slide-next" role="group"
                        aria-label="2 / 4" style="width: 295px; margin-right: 20px;">
                        <figure class="post-media br-sm">
                            <a href="post-single.html">
                    ...
                    <div class="swiper-slide post text-center overlay-zoom" role="group" aria-label="3 / 4"
                    ...
                    <div class="swiper-slide post text-center overlay-zoom" role="group" aria-label="4 / 4"
                        style="width: 295px; margin-right: 20px;">
                        <figure class="post-media br-sm">
                            <a href="post-single.html">
    ...
    <div class="swiper-container swiper-theme shadow-swiper appear-animate pb-4 mb-8 swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events"
        data-swiper-options="{
                    'spaceBetween': 20,
                    'slidesPerView': 2,
                    'breakpoints': {
        ...
        <div class="swiper-wrapper " id="swiper-wrapper-6e830c7340c91010b2" aria-live="polite"
            style="transform: translate3d(0px, 0px, 0px);">
            <div class="swiper-slide product-wrap mb-0 swiper-slide-active" role="group" aria-label="1 / 8"
                style="width: 137.5px; margin-right: 20px;">
            ...
            <!-- End of Product Wrap -->
            <div class="swiper-slide product-wrap mb-0 swiper-slide-next" role="group" aria-label="2 / 8"
                style="width: 137.5px; margin-right: 20px;">
                <div class="product text-center product-absolute">
                    <figure class="product-media">
                        <a href="https://www.portotheme.com/html/wolmart/product-defaproduct-default.html">
            ...
            <!-- End of Product Wrap -->
            <div class="swiper-slide product-wrap mb-0" role="group" aria-label="3 / 8"
                style="width: 137.5px; margin-right: 20px;">
                <div class="product text-center product-absolute">
                    <figure class="product-media">
                        <a href="https://www.portotheme.com/html/wolmart/product-defaproduct-default.html">
            ...
            <!-- End of Product Wrap -->
            <div class="swiper-slide product-wrap mb-0" role="group" aria-label="4 / 8"
                style="width: 137.5px; margin-right: 20px;">
                <div class="product text-center product-absolute">
                    <figure class="product-media">
                        <a href="https://www.portotheme.com/html/wolmart/product-defaproduct-default.html">
            ...
            <!-- End of Product Wrap -->
            <div class="swiper-slide product-wrap mb-0" role="group" aria-label="5 / 8"
                style="width: 137.5px; margin-right: 20px;">
                <div class="product text-center product-absolute">
                    <figure class="product-media">
                        <a href="https://www.portotheme.com/html/wolmart/product-defaproduct-default.html">
            ...
            <!-- End of Product Wrap -->
            <div class="swiper-slide product-wrap mb-0" role="group" aria-label="6 / 8"
                style="width: 137.5px; margin-right: 20px;">
                <div class="product text-center product-absolute">
                    <figure class="product-media">
                        <a href="https://www.portotheme.com/html/wolmart/product-defaproduct-default.html">
            ...
            <!-- End of Product Wrap -->
            <div class="swiper-slide product-wrap mb-0" role="group" aria-label="7 / 8"
                style="width: 137.5px; margin-right: 20px;">
                <div class="product text-center product-absolute">
                    <figure class="product-media">
                        <a href="https://www.portotheme.com/html/wolmart/product-defaproduct-default.html">
            ...
            <!-- End of Product Wrap -->
            <div class="swiper-slide product-wrap mb-0" role="group" aria-label="8 / 8"
                style="width: 137.5px; margin-right: 20px;">
                <div class="product text-center product-absolute">
                    <figure class="product-media">
                        <a href="https://www.portotheme.com/html/wolmart/product-defaproduct-default.html">
